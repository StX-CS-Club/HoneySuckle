...
public final class Rendering {
    ...
    public static BufferedImage scroll(int length) {
        ...
        g.drawImage(Rendering.texture("hud/scroll_end", null), 0, 0, 4, 32, null);
        for (int i = 0; i < length; i++) {
            g.drawImage(Rendering.texture("hud/scroll_middle", null), 4 + i * 4, 0, 4, 32, null);
        }
        g.drawImage(Rendering.texture("hud/scroll_end", null), 4 + length * 4, 0, 4, 32, null);
